...
// Mock photography data for development when Convex is not available
// In production, this will be replaced by real Convex data
export const mockPhotographyData: Omit<Photo, '_id' | '_creationTime'>[] = [
  {
    title: 'Golden Hour',
...
// Convert mock data to Photo type with generated IDs
export function getMockPhotography(): Photo[] {
  return mockPhotographyData.map((photo, index) => ({
    ...photo,
    _id: `mock-photo-${index + 1}`,
